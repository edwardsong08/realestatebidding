...
const AboutUs = () => {
  ...
  return (
    <div className="aboutus-page">
      ...
      {/* Story Section: Only the card fades in */}
      <section className="story-section">
        <div className="story-card fade-element">
          <h2>Our Story &amp; Vision</h2>
          <p>
            RealEstateBidding was founded by industry experts determined to revolutionize property transactions.
          ...
          <p>
            At RealEstateBidding, our journey began with a simple yet powerful realization: the traditional real estate market is ripe for transformation. Founded by seasoned industry professionals, we witnessed firsthand the challenges of opaque transactions and inefficient processes. Determined to redefine these experiences, we envisioned a platform where technology and transparency converge to empower every participant.
          </p>
          <p>
            Our vision is to build a seamless, data‑driven marketplace that elevates the standards of trust and efficiency in property transactions. By harnessing cutting‑edge technology alongside time‑honored values, we create an environment where buyers, sellers, and professionals can engage with complete confidence. Every decision we make is rooted in a commitment to ethical practices and a passion for innovation, ensuring that every deal reflects clarity, fairness, and mutual respect.
          </p>
        </div>
      </section>

      {/* Mission & Values Section */}
      <section className="mission-values-section fade-element">
      ...
      {/* Team Section */}
      <section className="team-section fade-element">
